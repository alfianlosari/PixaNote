...
public class LatestNoteListFragment extends Fragment
    ...
    private final String TAG = LatestNoteListFragment.class.getSimpleName();
    ...
    DatabaseReference mPicturesDatabaseRef = FirebaseDatabase.getInstance().getReference("pics");
    ...
    ValueEventListener mPicturesValueEventListener;
    ValueEventListener mUserLikesValueEventListener;

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState) {
        View rootView = inflater.inflate(R.layout.fragment_latest_note_list, container, false);
    ...
    public void onResume() {
        ...
        mPicturesValueEventListener =  mPicturesDatabaseRef.addValueEventListener(new ValueEventListener() {
            @Override
    ...
    public void onPause() {
        super.onPause();
        if (mPicturesValueEventListener != null) {
            mPicturesDatabaseRef.removeEventListener(mPicturesValueEventListener);
        }
